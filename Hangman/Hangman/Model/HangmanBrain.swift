...
class HangmanBrain {
    ...
    static var backgroundColor: [UIColor] = [#colorLiteral(red: 0.3187960982, green: 0.5831527114, blue: 0.3352566361, alpha: 1),#colorLiteral(red: 0.2605174184, green: 0.2605243921, blue: 0.260520637, alpha: 1)]
